...
public class AlibabaCloudAccessKeyIDsRuleTest {
  ...
  AlibabaCloudAccessKeyIDsRule underTest = new AlibabaCloudAccessKeyIDsRule();

  @Test
  public void testRuleProperties() {
    assertThat(underTest.getRuleKey()).isEqualTo("S6336");
    assertThat(underTest.getMessage()).isEqualTo("Make sure this Alibaba Cloud Access Key ID is not disclosed.");
  }

  @Test
  public void testRuleRegexPositive() {
    List<Secret> secrets = underTest.findSecretsIn(aNormalizedInputFile("LTAI5tBcc9SecYAomgyUSFs8"));

    assertThat(secrets)
      .extracting(Secret::getTextRange)
      .extracting("start.line", "start.lineOffset", "end.line", "end.lineOffset")
      .containsOnly(tuple(1, 0, 1, 24));
  }

  @Test
  public void testRuleRegexNegative() {
    List<Secret> secrets = underTest.findSecretsIn(aNormalizedInputFile("LNTTAI5tBcc9SecYAomgyUSFs8"));
