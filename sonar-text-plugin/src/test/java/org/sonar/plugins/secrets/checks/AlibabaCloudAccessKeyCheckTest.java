...
public class AlibabaCloudAccessKeyCheckTest {

  Check check = new AlibabaCloudAccessKeyCheck();

  @Test
  public void testAlibabaCloudAccessKeyIDsPositive() throws IOException {
  ...
  @Test
  public void testAlibabaCloudAccessKeyIDsNegative() throws IOException {
    Collection<Issue> issues = analyze(check, inputFile("LNTTAI5tBcc9SecYAomgyUSFs8"));
    assertThat(issues).isEmpty();
  }

  @Test
  public void testAlibabaCloudAccessKeySecrets1Positive() throws IOException {
  ...
  @Test
  public void testAlibabaCloudAccessKeySecrets2Positive() throws IOException {
  ...
  @Test
  public void testAlibabaCloudAccessKeySecretsNegative() throws Exception {
  ...
  @Test
  public void testAlibabaCloudAccessKeySecretsExamplePositive() throws IOException {
    Collection<Issue> issues = analyze(check, inputFile("String aliyunAccessKeySecret=\"KmkwlDrPBC68bgvZiNtrjonKIYmVT8\";"));
    assertThat(asString(issues)).containsExactly(
      "secrets:S6336 [1:30-1:60] Make sure this Alibaba Cloud Access Key Secret is not disclosed.");
  }
  ...
  @Test
  public void testAlibabaCloudAccessKeySecretsExampleNegativeLowEntropy() throws IOException {
