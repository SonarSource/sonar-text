...
Write-Host SNK path is: $env:SNK_PATH
dotnet build --no-restore /nologo /nr:false /p:platform="Any CPU" /p:configuration="Release" /p:VisualStudioVersion="17.0" /p:SignAssembly="true" /p:AssemblyOriginatorKeyFile=$env:SNK_PATH
