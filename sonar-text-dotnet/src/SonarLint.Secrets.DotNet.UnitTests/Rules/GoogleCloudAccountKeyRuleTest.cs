...
namespace SonarLint.Secrets.DotNet.UnitTests.Rules
{
    ...
    {
        private readonly string commonTestFilePath = "..\\sonar-text-plugin\\src\\test\\resources\\checks\\";
        ...
        public void TestRuleRegexPositive()
        {
            ...
            var input = readFileAndNormalize(commonTestFilePath + "GoogleCloudAccountKeyCheck\\GoogleCloudAccountPositive.json", UTF_8);
        ...
        public void TestRuleRegexNegative()
        {
            ...
            var secrets = testSubject.Find(readFileAndNormalize(commonTestFilePath + "GoogleCloudAccountKeyCheck\\GoogleCloudAccountNegative.json", UTF_8));
